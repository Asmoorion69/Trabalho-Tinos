...
//Implementa o algoritimo de inserção direta para ordenar o vetor de strings
...
//Ordena os códigos de cada mes usando o algoritmo de inserção direta
...
//Exibe o numero de comparaçoes e movimentações realizadas em cada ordenação
    for(int i = 0; i < 5; i++){
